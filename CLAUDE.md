...
- Cached OAuth tokens are preserved across sessions (reuse existing login)
- To switch accounts or force fresh login, use the `oh-my-notionmcp-reauth` MCP tool or `oh-my-notionmcp reauth` CLI command
